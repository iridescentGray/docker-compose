...
AUTO_CODE_ACCOUNT = {"user": "admin", "pwd": "123456"}
...
OUT_PUT_LOG_TO_FILE_PATH = "/data/12306.log"  # 日志目录
RUNTIME_DIR = "/data/"
...
EMAIL_RECEIVER = (
    "receiver@example.com"  # 邮件接受者 # 可以多个 [email1@gmail.com, email2@gmail.com]
)
...
WEB_USER = {"username": "admin", "password": "password"}  # 登录信息
WEB_PORT = 8008  # 监听端口
...
QUERY_JOBS = [
    {
        ...
        "left_dates": ["2024-05-16", "2024-05-17"],  # 出发日期 :Array
        ...
        "period": {"from": "00:00", "to": "24:00"},  # 筛选时间
    },
    # {
